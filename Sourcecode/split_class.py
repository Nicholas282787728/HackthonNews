...
for line in file_story_class:
	...
	if cur_class == 0:
		print >> file_story_class0, "%s\t%s\t%s\t%s" % (story_id, title, text, time)
	elif cur_class == 1:
		print >> file_story_class1, "%s\t%s\t%s\t%s" % (story_id, title, text, time)
	elif cur_class == 2:
		print >> file_story_class2, "%s\t%s\t%s\t%s" % (story_id, title, text, time)
	elif cur_class == 3:
		print >> file_story_class3, "%s\t%s\t%s\t%s" % (story_id, title, text, time)
	elif cur_class == 4:
		print >> file_story_class4, "%s\t%s\t%s\t%s" % (story_id, title, text, time)
